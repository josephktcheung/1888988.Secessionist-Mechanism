...
- 玩家在此新停战协议期间与阿拉贡和教宗国形成同盟
- 卡斯蒂利亚归并国叛乱爆发
- 对手（卡斯蒂利亚）被迫加入叛乱一方，受到 -50 稳定度，无法召唤同盟
- 玩家召唤阿拉贡和教宗国，以压倒性优势再次攻击对手
...
5. 观察法兰西（防御方）可以召唤同盟（阿拉贡、教宗国）加入防御性战争
...
- French 归并国叛乱 spawns as 群众集会 (<50% French culture population)
- 法兰西 (culturally dominant) is forcibly called to support the 叛乱
- 法兰西 has 同盟 with 阿拉贡 and 教宗国
- 法兰西 has 100 人情 with 阿拉贡 and 教宗国
...
1. 加载存档 1337.5.1 - 卡斯蒂利亚盟友葡萄牙, 征服 Loudun, 添加叛乱 100%
   ...
   - 控制台：`conquer loudun`
   - 将叛乱进度添加到 1（100%）
2. 加载存档 1337.5.1 - 法兰西盟友教宗国, 阿拉贡, 人情 100
   - 切换标签作为法兰西游戏
   - 法兰西与阿拉贡、教宗国结盟
   - 使用控制台命令 `favor ARA 100` 和 `favor PAP 100` 添加人情
3. 加载存档 1337.6.1 - 法兰西分离主义战争
   - 归并国叛军在 1337.6.1 爆发
   - Loudun 中的群众集会叛军是战争领袖，因此法兰西无法召唤阿拉贡和教宗国参战
4. 加载存档 1337.6.3 - 法兰西消灭无地叛军, 可以召唤阿拉贡和教宗国
   - 使用控制台命令 `kill_unit` 消灭群众集会归并国叛军部队
   - 法兰西成为战争领袖
   - 法兰西可以使用人情召唤阿拉贡和教宗国加入战争
...
- 1337.5.1 - 法兰西盟友教宗国, 阿拉贡, 人情 100
- 1337.6.1 - 法兰西分离主义战争
- 1337.6.3 - 法兰西消灭无地叛军, 可以召唤阿拉贡和教宗国
